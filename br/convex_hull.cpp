...
int main(int argc, char *argv[])
{
	...
	for (;;)
	{
		...
		//conver to hsv and blur image
		//cvtColor(img_raw, img_converted, CV_BGR2HSV);
		cvtColor(img_raw, img_converted, COLOR_BGR2YCrCb);
		//blur(hsv, hsv, Size(3, 3));

		//threshold image
		//inRange(img_converted, Scalar(0, 10, 60), Scalar(20, 150, 255), img_thresholded); //HSV
		inRange(img_converted, Scalar(80, 133, 77), Scalar(179, 173, 127), fore); //YCrCb
